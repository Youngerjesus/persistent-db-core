...
| `gate-v1-indexes` | `REQ-7-implement-integer-primary-key-as-9c698e08` | `tests/primary_index.rs`; `tests/sql_exec.rs`; `scripts/verify_primary_index_acceptance`; `specs/v1-primary-index-current-artifact-evidence-refresh/final_review.md`; `specs/v1-primary-index-current-artifact-evidence-refresh/artifact_identity.sha256` | Verified artifact: base HEAD `69fc6b95640bdeed3f7d4249d2ffedc5e6c336ed` plus task package identity manifest; `cargo test --test primary_index`; `cargo test --test sql_exec primary_key`; `scripts/verify_primary_index_acceptance`; `scripts/verify` | `verified_current_run` |
