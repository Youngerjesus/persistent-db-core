...
- head_sha: 8adb253bac616445f6e389e29048e4296f0ce85b
- base_branch: main
- dirty_files: none
- collected_at: 2026-05-17T14:49:07.269949+00:00
- selected_files: src/main.rs, src/lib.rs, src/storage.rs, tests/cli_contract.rs, tests/page_storage.rs, tests/primary_index.rs, tests/sql_exec.rs, docs/file_format.md, docs/cli_contract.md

## Omitted Reasons
- /: context path escapes repo root: /
...
- autopilot/project_manager/specs/v1-primary-btree-index/contracts.md: not_git_tracked
- autopilot/project_manager/specs/v1-primary-btree-index/spec.md: not_git_tracked
...
- commit/rollback: not_git_tracked
- docs/history_archives/history.md: context_char_limit
- flow:wal-replay-recovery: not_git_tracked
- lookup/ordered: not_git_tracked
...
- persistent-db-core_worktree/main/tests/primary_index.rs: not_git_tracked
...
- route:db-exec: not_git_tracked
- schema/execute: not_git_tracked
- storage/execution: not_git_tracked
...
```text
error: SQL semantic error: type mismatch for column id: expect
```
